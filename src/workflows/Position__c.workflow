...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>Recruiting_App_Email_Template/Recruiting_App_New_Position_Alert</template>
    </alerts>
    <fieldUpdates>
        <fullName>Reassign_Position_to_Queue</fullName>
        <description>Assign the Position to the Unclaimed Position Queue</description>
        <field>OwnerId</field>
        <lookupValue>UnclaimedPositionQueue</lookupValue>
    ...
    <fieldUpdates>
        <fullName>Set_Status_to_Open_Approved1</fullName>
    ...
    <fieldUpdates>
        <fullName>Set_Status_to_Pending_Approvall</fullName>
        <field>Status__c</field>
        <literalValue>Pending Approval</literalValue>
        <name>Set Status to Pending Approval</name>
        <notifyAssignee>false</notifyAssignee>
